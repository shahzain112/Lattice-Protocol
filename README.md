...
**[GitHub](https://github.com/shahzain112/Lattice-Protocol)** | **[Documentatio](https://github.com/shahzain112/Lattice-Protocol/wiki)**
...
# Bridge MCP Tool Examplecurl -X POST http://localhost:8080/lattice/v1/execute \  -H "Content-Type: application/json" \  -d '    },    "timestamp": '$(date +%s)'  }'
